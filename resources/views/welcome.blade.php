...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <footer class="bg-green-500 h-60">
            <div class="flex grid-cols-2 py-16 items-center justify-between">
                <div class="pl=10 text-gray-100">
                ...
                <div class="flex items-center justify-evely gap-8">
                    
                    <img src="{{ asset('assets/imgs/instagram.svg')}}">
                    <img src="{{ asset('assets/imgs/facebook.svg')}}">
                    <img src="{{ asset('assets/imgs/youtube.svg')}}">
                </div>
            </div>
        </footer>
